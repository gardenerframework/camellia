...
public class OAuth2StateEndpoint {
    ...
    public CreateOAuth2StateResponse createState(
            @AuthenticationTypeSupported(
                    //要求是oauth2 iam的认证服务
                    type = OAuth2BasedUserAuthenticationService.class,
                    //这种认证服务当然不是保留的
        ...
        OAuth2BasedUserAuthenticationService service = (OAuth2BasedUserAuthenticationService) registry.getUserAuthenticationService(type);
