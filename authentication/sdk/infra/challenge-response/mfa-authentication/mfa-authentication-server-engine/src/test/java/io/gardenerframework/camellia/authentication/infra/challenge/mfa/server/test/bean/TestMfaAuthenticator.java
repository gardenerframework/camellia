...
public class TestMfaAuthenticator implements MfaAuthenticator<
    ...
    @Override
    public TestChallengeRequest createChallengeRequest(@NonNull Map<String, Object> userData, @Nullable RequestingClient client, Class<? extends Scenario> scenario, Map<String, Object> arguments) {
