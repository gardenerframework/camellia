...
import io.gardenerframework.camellia.authentication.infra.challenge.mfa.server.test.bean.TestChallengeRequest;
...
public class MfaAuthenticationServerEngineTest {
    ...
    public void smokeTest() {
        ...
        Map<String, Object> deem = new HashMap<>();
        deem.put("any", null);
        Assertions.assertThrows(HttpClientErrorException.class,
                () -> restTemplate.postForObject(
                        ...
                        new SendChallengeRequest(
                                deem,
                                objectMapper.convertValue(client, new TypeReference<Map<String, Object>>() {
                                }),
        ...
        TestChallenge challenge = restTemplate.postForObject(
                "http://localhost:{port}/mfa/test:send",
                new SendChallengeRequest(
                        objectMapper.convertValue(new TestChallengeRequest(UUID.randomUUID().toString()), new TypeReference<Map<String, Object>>() {
                        }),
                        objectMapper.convertValue(client, new TypeReference<Map<String, Object>>() {
                        }),
                        TestScenario.class.getName()),
