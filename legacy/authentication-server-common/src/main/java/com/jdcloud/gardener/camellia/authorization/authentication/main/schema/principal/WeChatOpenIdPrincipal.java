...
@ReferLogTarget(value = BasicPrincipal.class, prefix = "微信openid类型的")
public class WeChatOpenIdPrincipal extends BasicPrincipal {
    private static final long serialVersionUID = Version.current;

    public WeChatOpenIdPrincipal(String name) {
        super(name);
    }
}
