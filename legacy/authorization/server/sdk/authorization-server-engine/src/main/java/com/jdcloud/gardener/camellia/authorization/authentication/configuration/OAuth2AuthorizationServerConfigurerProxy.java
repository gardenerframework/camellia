...
import com.jdcloud.gardener.camellia.authorization.authentication.main.OidcUserInfoMapper;
import com.jdcloud.gardener.camellia.authorization.authentication.main.support.oauth2.TokenEndpointAuthenticationConverterDelegate;
...
@Component
public class OAuth2AuthorizationServerConfigurerProxy extends AuthorizationServerEngineSecurityConfigurer {
    ...
    public void configure(HttpSecurity builder) throws Exception {
        ...
        oAuth2AuthorizationServerConfigurer.authorizationEndpoint(
                oAuth2AuthorizationEndpointConfigurer -> oAuth2AuthorizationEndpointConfigurer.consentPage(authorizationServerPathOption.getOAuth2AuthorizationConsentPage())
        );
