...
import com.jdcloud.gardener.camellia.authorization.authentication.main.user.UserServiceDelegate;
...
public class LoginAuthenticationRequestAuthenticator implements AuthenticationProvider, ApplicationEventPublisherAware {
    ...
    private Authentication authenticateInternally(Authentication authentication) throws Exception {
        ...
        //当前登录使用的登录名
        BasicPrincipal principal = userAuthenticationRequestToken.getPrincipal();
        Assert.notNull(principal, "principal must not be null");
        BasicCredentials credentials = userAuthenticationRequestToken.getCredentials();
