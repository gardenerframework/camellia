...
@NoArgsConstructor
@SuperBuilder
public class SearchClientCriteriaParameterTemplate extends SearchCriteriaParameterBase implements
    ...
    public SearchClientCriteriaParameterTemplate(Collection<String> must, Collection<String> should, String id, String name) {
        super(must, should);
        this.id = id;
        this.name = name;
    }
