...
public class ApplicationAlreadyExistedException extends ApplicationExceptions.ClientSideException {
    public ApplicationAlreadyExistedException(String applicationId) {
        super(applicationId);
    }
}
